...
import static com.google.maps.android.utils.demo.R.id.map;
...
public class HeatmapsDemoActivity extends BaseDemoActivity {
    ...
    protected void startDemo() {
        getMap().moveCamera(CameraUpdateFactory.newLatLngZoom(new LatLng(37.777, -122.435), 8));
        ...
        try {
            mLists.put(getString(R.string.medicare), new DataSet(readItems(R.raw.parking),
        ...
        getMap().addMarker(new MarkerOptions()
                .position(new LatLng(37.783307, -122.399226))
